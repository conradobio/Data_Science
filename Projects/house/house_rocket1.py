...
def overview_data( data ):
    ...
    c2.header('Descriptive Analyses')
...
def commercial_distribution( data):
    ...
    st.header('Average Price per Year Buil')
...
def attributes_distribution ( data ):
    ...
    # filters
    f_floors = st.sidebar.selectbox('Max number og floors',
